...
struct Materials {
    ...
    static Material* OCEAN_PLANT;
    static Material* TALL_PLANTS;
    static Material* NETHER_PLANTS;
    static Material* SEA_GRASS;
    static Material* WATER;
    static Material* BUBBLE_COLUMN;
    static Material* LAVA;
    static Material* SNOW;
    static Material* FIRE;
    static Material* MISCELLANEOUS;
    static Material* WEB;
    ...
    static Material* SHULKER;
    static Material* WOOD;
    static Material* NETHER_WOOD;
    static Material* BAMBOO_SAPLING;
