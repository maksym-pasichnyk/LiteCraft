...
//
//        for (auto& [name, data] : blocks.as_object().value()) {
...
////    }
//
//    if (auto textures = data.find("textures")) {
//        graphics->setTextures(*textures);
//    }
...
//    if (data.is_object()) {
//        topTexture = getTextureItem(data.at("up").as_string().value());
//        bottomTexture = getTextureItem(data.at("down").as_string().value());
//
//        if (data.contains("side")) {
//            auto texture = getTextureItem(data.at("side").as_string().value());
//
...
//            westTexture = texture;
//        } else {
//            southTexture = getTextureItem(data.at("south").as_string().value());
//            northTexture = getTextureItem(data.at("north").as_string().value());
//            eastTexture = getTextureItem(data.at("east").as_string().value());
//            westTexture = getTextureItem(data.at("west").as_string().value());
//        }
//    } else {
//        auto texture = getTextureItem(data.as_string().value());
//
//        topTexture = texture;
