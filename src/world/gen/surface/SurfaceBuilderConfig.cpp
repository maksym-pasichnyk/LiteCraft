...
void SurfaceBuilderConfig::registerConfigs() {
    ...
    const BlockData SNOW{Block::snow->id, 0};
    ...
    const BlockData CRIMSON_NYLIUM{Block::crimson_nylium->id, 0};
    const BlockData WARPED_NYLIUM{Block::warped_nylium->id, 0};
    const BlockData NETHER_WART_BLOCK{Block::nether_wart_block->id, 0};
    const BlockData WARPED_WART_BLOCK{Block::warped_wart_block->id, 0};
    const BlockData BLACKSTONE{Block::blackstone->id, 0};
    const BlockData BASALT{Block::basalt->id, 0};
    const BlockData MAGMA_BLOCK{Block::magma->id, 0};
