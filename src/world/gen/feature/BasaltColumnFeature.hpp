...
struct BasaltColumnFeature : Feature {
    ...
    static auto func_236246_a_(WorldGenRegion &reader, int p_236246_1_, const BlockPos& pos, int p_236246_3_) -> tl::optional<BlockPos>;
    static auto func_236249_a_(WorldGenRegion &reader, const BlockPos& pos, int p_236249_2_) -> tl::optional<BlockPos>;
