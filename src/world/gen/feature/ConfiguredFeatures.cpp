...
// DISK_CLAY = registerFeature("disk_clay", Features::DISK->withConfiguration(new SphereReplaceConfig(Blocks::CLAY->getDefaultState(), FeatureSpread.create(2, 1), 1, ImmutableList.of(Blocks::DIRT->getDefaultState(), Blocks::CLAY->getDefaultState())))->withPlacement(SEAGRASS_DISK_PLACEMENT));
// DISK_GRAVEL = registerFeature("disk_gravel", Features::DISK->withConfiguration(new SphereReplaceConfig(Blocks::GRAVEL->getDefaultState(), FeatureSpread.create(2, 3), 2, ImmutableList.of(Blocks::DIRT->getDefaultState(), Blocks::GRASS_BLOCK->getDefaultState())))->withPlacement(SEAGRASS_DISK_PLACEMENT));
// DISK_SAND = registerFeature("disk_sand", Features::DISK->withConfiguration(new SphereReplaceConfig(Blocks::SAND->getDefaultState(), FeatureSpread.create(2, 4), 2, ImmutableList.of(Blocks::DIRT->getDefaultState(), Blocks::GRASS_BLOCK->getDefaultState())))->withPlacement(SEAGRASS_DISK_PLACEMENT)->withSpreadPlacement(3));
...
// ORE_GOLD_DELTAS = registerFeature("ore_gold_deltas", Features::ORE->withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHERRACK, Blocks::NETHER_GOLD_ORE->getDefaultState(), 10))->withPlacement(NETHER_SPRING_ORE_PLACEMENT)->square()->withSpreadPlacement(20));
// ORE_QUARTZ_DELTAS = registerFeature("ore_quartz_deltas", Features::ORE->withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHERRACK, Blocks::NETHER_QUARTZ_ORE->getDefaultState(), 14))->withPlacement(NETHER_SPRING_ORE_PLACEMENT)->square()->withSpreadPlacement(32));
// ORE_GOLD_NETHER = registerFeature("ore_gold_nether", Features::ORE->withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHERRACK, Blocks::NETHER_GOLD_ORE->getDefaultState(), 10))->withPlacement(NETHER_SPRING_ORE_PLACEMENT)->square()->withSpreadPlacement(10));
// ORE_QUARTZ_NETHER = registerFeature("ore_quartz_nether", Features::ORE->withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHERRACK, Blocks::NETHER_QUARTZ_ORE->getDefaultState(), 14))->withPlacement(NETHER_SPRING_ORE_PLACEMENT)->square()->withSpreadPlacement(16));
// ORE_GRAVEL_NETHER = registerFeature("ore_gravel_nether", Features::ORE->withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHERRACK, Blocks::GRAVEL->getDefaultState(), 33))->withPlacement(Placement->range->withConfiguration(new TopSolidRangeConfig(5, 0, 37)))->square()->withSpreadPlacement(2));
// ORE_BLACKSTONE = registerFeature("ore_blackstone", Features::ORE->withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHERRACK, Blocks::BLACKSTONE->getDefaultState(), 33))->withPlacement(Placement->range->withConfiguration(new TopSolidRangeConfig(5, 10, 37)))->square()->withSpreadPlacement(2));
...
// ORE_DEBRIS_SMALL = registerFeature("ore_debris_small", Features::NO_SURFACE_ORE->withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_NETHER, Blocks::ANCIENT_DEBRIS->getDefaultState(), 2))->withPlacement(Placement->range->withConfiguration(new TopSolidRangeConfig(8, 16, 128)))->square());
