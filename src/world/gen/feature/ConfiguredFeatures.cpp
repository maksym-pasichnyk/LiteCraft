...
void ConfiguredFeatures::configureFeatures() {
    static BlockClusterFeatureConfig GRASS_PATCH_CONFIG {
        .stateProvider = new SimpleBlockStateProvider(Blocks::GRASS->getStateWithMeta(1)),
...
//static BlockClusterFeatureConfig DEAD_BUSH_CONFIG = (new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(Features.States.DEAD_BUSH), SimpleBlockPlacer.PLACER)).tries(4).build();
...
// ORE_GOLD_EXTRA = registerFeature("ore_gold_extra", Features::ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, Features.States.GOLD_ORE, 9))->withPlacement(Placement.RANGE->withConfiguration(new TopSolidRangeConfig(32, 32, 80))).square()->withSpreadPlacement(20));
...
// ORE_LAPIS = registerFeature("ore_lapis", Features::ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, Features.States.LAPIS_ORE, 7))->withPlacement(Placement.DEPTH_AVERAGE->withConfiguration(new DepthAverageConfig(16, 16))).square());
