...
// DISK_CLAY = registerFeature("disk_clay", Features::DISK->withConfiguration(new SphereReplaceConfig(Blocks::CLAY->getDefaultState(), FeatureSpread.create(2, 1), 1, ImmutableList.of(Blocks::DIRT->getDefaultState(), Blocks::CLAY->getDefaultState())))->withPlacement(DISK_PLACEMENT));
// DISK_GRAVEL = registerFeature("disk_gravel", Features::DISK->withConfiguration(new SphereReplaceConfig(Blocks::GRAVEL->getDefaultState(), FeatureSpread.create(2, 3), 2, ImmutableList.of(Blocks::DIRT->getDefaultState(), Blocks::GRASS_BLOCK->getDefaultState())))->withPlacement(DISK_PLACEMENT));
// DISK_SAND = registerFeature("disk_sand", Features::DISK->withConfiguration(new SphereReplaceConfig(Blocks::SAND->getDefaultState(), FeatureSpread.create(2, 4), 2, ImmutableList.of(Blocks::DIRT->getDefaultState(), Blocks::GRASS_BLOCK->getDefaultState())))->withPlacement(DISK_PLACEMENT)->withSpreadPlacement(3));
