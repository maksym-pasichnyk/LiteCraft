...
void Shipwreck::createComponents(StructurePieces& pieces, StructureGenerateContext& context, const StructureConfig& config) {
    ...
    const auto position = context.pos.getStartBlock().up(90);
