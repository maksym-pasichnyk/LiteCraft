...
//    MANSION = registerStructure("mansion", Structures::WOODLAND_MANSION->withConfiguration(NoFeatureConfig{}));
    JUNGLE_PYRAMID = registerStructure("jungle_pyramid", Structures::JUNGLE_PYRAMID->withConfiguration(NoFeatureConfig{}));
    DESERT_PYRAMID = registerStructure("desert_pyramid", Structures::DESERT_PYRAMID->withConfiguration(NoFeatureConfig{}));
//    IGLOO = registerStructure("igloo", Structures::IGLOO->withConfiguration(NoFeatureConfig{}));
...
//    SHIPWRECK_BEACHED = registerStructure("shipwreck_beached", Structures::SHIPWRECK->withConfiguration(new ShipwreckConfig(true)));
    SWAMP_HUT = registerStructure("swamp_hut", Structures::SWAMP_HUT->withConfiguration(NoFeatureConfig{}));
//    STRONGHOLD = registerStructure("stronghold", Structures::STRONGHOLD->withConfiguration(NoFeatureConfig{}));
//    MONUMENT = registerStructure("monument", Structures::MONUMENT->withConfiguration(NoFeatureConfig{}));
...
//    FORTRESS = registerStructure("fortress", Structures::FORTRESS->withConfiguration(NoFeatureConfig{}));
//    NETHER_FOSSIL = registerStructure("nether_fossil", Structures::NETHER_FOSSIL->withConfiguration(NoFeatureConfig{}));
//    END_CITY = registerStructure("end_city", Structures::END_CITY->withConfiguration(NoFeatureConfig{}));
