...
void StructureFeatures::init() {
	PILLAGER_OUTPOST = configure("pillager_outpost", Structures::PILLAGER_OUTPOST, JigsawConfig{PillagerOutpostPools::START, 7});
	...
	BASTION_REMNANT = configure("bastion_remnant", Structures::BASTION_REMNANT, JigsawConfig{BastionRemnantsPieces::START, 6});
	VILLAGE_PLAINS = configure("village_plains", Structures::VILLAGE, JigsawConfig{PlainVillagePools::START, 6});
	VILLAGE_DESERT = configure("village_desert", Structures::VILLAGE, JigsawConfig{DesertVillagePools::START, 6});
	VILLAGE_SAVANNA = configure("village_savanna", Structures::VILLAGE, JigsawConfig{SavannaVillagePools::START, 6});
	VILLAGE_SNOWY = configure("village_snowy", Structures::VILLAGE, JigsawConfig{SnowyVillagePools::START, 6});
	VILLAGE_TAIGA = configure("village_taiga", Structures::VILLAGE, JigsawConfig{TaigaVillagePools::START, 6});
